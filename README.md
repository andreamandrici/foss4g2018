...
If something of the above goes wrong, the following [script](scripts/script_04_create_functions.sh) and [related sql code](scripts/sql/sl03_functions.sql) will create the needed functions for the next step (only needed if something didn't work during the previous exercises)				
